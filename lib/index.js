...
var prosemirrorModel = __webpack_require__(1);
var prosemirrorTransform = __webpack_require__(3);
...
var OrderedMap = _interopDefault(__webpack_require__(8));
...
var prosemirrorState = __webpack_require__(0);
var prosemirrorModel = __webpack_require__(1);
var prosemirrorTransform = __webpack_require__(3);
...
var keyName = _interopDefault(__webpack_require__(9));
var prosemirrorState = __webpack_require__(0);
...
var RopeSequence = _interopDefault(__webpack_require__(10));
var prosemirrorTransform = __webpack_require__(3);
var prosemirrorState = __webpack_require__(0);
...
const schema_schema = new dist["Schema"]({
  nodes: {
    text: {},
    block: {
      content: "text*",
...
function enter(state, dispatch, view) {
  ...
  commands["baseKeymap"]['Enter'](state, dispatch);
  ...
  if (indents && !empty) {
    ...
    const node = resolved.nodeAfter; // reset head and tail attrs
...
// CONCATENATED MODULE: ./src/lexer/InputStream.js
class InputStream {
  constructor(input) {
    this.reset(input);
    this.state = [];
...
/* harmony default export */ var lexer_InputStream = (InputStream);
// CONCATENATED MODULE: ./src/lexer/BaseTokenStream.js
...
/* harmony default export */ var lexer_BaseTokenStream = (BaseTokenStream);
// CONCATENATED MODULE: ./src/lexer/predicates.js
...
// CONCATENATED MODULE: ./src/actions/parse.js
...
class parse_TokenStream extends lexer_BaseTokenStream {
  constructor(istream) {
    super(istream);
  }
...
const parse = src => {
  const istream = new lexer_InputStream(src);
  const tstream = new parse_TokenStream(istream);
  const astream = new parse_ASTStream(tstream);
  return astream.parse();
};


// CONCATENATED MODULE: ./src/actions/execute.js


class execute_Executor {
  constructor(ast, blockFrom, state, meta, docStruct, functions) {
    ...
    this.tr = state.tr;
    this.mapping = new prosemirror_transform_dist["Mapping"]();
    this.setMeta(this.tr);
    this.shouldUpdate = false; // if first function isnt a selector, make it this
  ...
  executeNewContext(ast, fns) {
    const subexecute = new execute_Executor(ast, this.blockFrom, this.currentState, this.meta, this.docStruct, fns);
...
/* harmony default export */ var execute = (execute_Executor);
// CONCATENATED MODULE: ./src/actions/selector.js
...
const selectorNearest = (docStruct, tag, node) => {
  ...
  } while (parent = parent.parent); // check descendants
...
// CONCATENATED MODULE: ./src/actions/validate.js
...
// CONCATENATED MODULE: ./src/actions/utils.js
...
// CONCATENATED MODULE: ./src/actions/functions/block/after.js




const trimHead = (text, head, tail) => {
  const trimmed = tail && text.endsWith(tail) ? text.substring(0, text.length - tail.length) : text;
  return head && trimmed.startsWith(head) ? text.substr(head.length) : text;
};
  ...
  stdin.forEach((b, i) => {
    ...
    if (!trimmedText.endsWith(template)) {
      ...
      if (selection.from === dest && selection.empty) {
        ...
        this.tr.setSelection(prosemirror_state_dist["TextSelection"].create(this.tr.doc, dest));
      } else {
        this.tr.insertText(template, dest);
      }
    }
...
;
/* harmony default export */ var block_after = (after);
// CONCATENATED MODULE: ./src/actions/functions/block/before.js




const trimTail = (text, head, tail) => {
  const trimmed = head && text.startsWith(head) ? text.substr(head.length) : text;
  return tail && trimmed.endsWith(tail) ? text.substring(0, text.length - tail.length) : text;
};
...
function before(stdin, args) {
  ...
  stdin.forEach(b => {
    ...
    const trimmedText = trimTail(text, node.attrs.head, node.attrs.tail); // console.log('before', JSON.stringify({head, trimmedText, template}))
...
;
/* harmony default export */ var block_before = (before);
// CONCATENATED MODULE: ./src/actions/functions/block/duplicate.js
...
;
/* harmony default export */ var block_duplicate = (duplicate);
// CONCATENATED MODULE: ./src/actions/functions/block/flatten.js
...
function flatten(stdin, args) {
  ...
  stdin.forEach(b => {
    const block = this.docStruct.find(b.from);
    this.tr.insertText('', this.tr.mapping.map(b.from) + 1, this.tr.mapping.map(b.from) + block.depth + 1);
  });
  return stdin.map(b => b.applyMapping(this.tr.mapping));
}

;
/* harmony default export */ var block_flatten = (flatten);
// CONCATENATED MODULE: ./src/actions/functions/block/hide.js
...
;
/* harmony default export */ var block_hide = (hide);
// CONCATENATED MODULE: ./src/actions/functions/block/indent.js



function indent_indent(stdin, args) {
  if (!ensureSelectorResult(stdin)) {
  ...
  stdin.forEach(b => {
    const block = this.docStruct.find(b.from);
    this.tr.insertText(utils_createIndent(block.depth + 1), this.tr.mapping.map(b.from) + 1, this.tr.mapping.map(b.from) + block.depth + 1);
  });
  return stdin.map(b => b.applyMapping(this.tr.mapping));
}

;
/* harmony default export */ var block_indent = (indent_indent);
// CONCATENATED MODULE: ./src/actions/functions/selector/all.js



function all_all(stdin, args) {
  const out = [];
...
;
/* harmony default export */ var selector_all = (all_all);
// CONCATENATED MODULE: ./src/actions/functions/selector/children.js




function children_children(stdin, args) {
  if (!ensureSelectorResult(stdin)) {
...
;
/* harmony default export */ var selector_children = (children_children);
// CONCATENATED MODULE: ./src/actions/functions/selector/descendants.js
...
;
/* harmony default export */ var selector_descendants = (descendants);
// CONCATENATED MODULE: ./src/actions/functions/selector/filter.js
  ...
  return stdin.filter(b => {
    ...
    switch (type) {
      ...
      case 'selector':
        ...
        return Boolean(block.features.find(f => f.type === 'tag' && tags.indexOf(f.label) !== -1));
    }
...
;
/* harmony default export */ var selector_filter = (filter);
// CONCATENATED MODULE: ./src/actions/functions/selector/first.js
...
;
/* harmony default export */ var selector_first = (first);
// CONCATENATED MODULE: ./src/actions/functions/selector/last.js
...
;
/* harmony default export */ var selector_last = (last);
// CONCATENATED MODULE: ./src/actions/functions/selector/next.js
...
/* harmony default export */ var selector_next = (next);
// CONCATENATED MODULE: ./src/actions/functions/selector/not.js
...
/* harmony default export */ var selector_not = (not);
// CONCATENATED MODULE: ./src/actions/functions/selector/parent.js



function parent_parent(stdin, args) {
  if (!ensureSelectorResult(stdin)) {
...
/* harmony default export */ var selector_parent = (parent_parent);
// CONCATENATED MODULE: ./src/actions/functions/selector/prev.js
...
;
/* harmony default export */ var selector_prev = (prev);
// CONCATENATED MODULE: ./src/actions/functions/selector/select.js



function select_select(stdin, args) {
  if (!args.length) {
    throw new ArgumentError('select', 'argument must have selector');
  }
...
;
/* harmony default export */ var selector_select = (select_select);
// CONCATENATED MODULE: ./src/actions/functions/selector/siblings.js




function siblings_siblings(stdin, args) {
  if (!ensureSelectorResult(stdin)) {
...
;
/* harmony default export */ var selector_siblings = (siblings_siblings);
// CONCATENATED MODULE: ./src/actions/functions/selector/slice.js


function slice_slice(stdin, args) {
  if (!ensureSelectorResult(stdin)) {
...
;
/* harmony default export */ var selector_slice = (slice_slice);
// CONCATENATED MODULE: ./src/actions/functions/selector/this.js
...
;
/* harmony default export */ var selector_this = (thisFn);
// CONCATENATED MODULE: ./src/actions/functions/selectors.js
...
const selectorFunctions = {
  ...
  descendants: selector_descendants,
  ...
  siblings: selector_siblings,
  slice: selector_slice,
  'this': selector_this,
  '>': selector_children,
  '*': selector_descendants
};
/* harmony default export */ var selectors = (selectorFunctions);
// CONCATENATED MODULE: ./src/actions/functions/block/move.js
...
function move(stdin, args) {
  ...
  const target = this.executeNewContext(args[0].value, selectors);
  ...
  let destPos = dest.to;
  const subtrees = getUniqueSubtrees(stdin.map(b => this.docStruct.find(b.from))); // get the last position of dest tree
  ...
  const nodes = []; // remove all nodes for moving
  ...
  subtrees.forEach(b => {
    ...
    recurseTree(block, c => {
      ...
      this.tr.delete(this.tr.mapping.map(c.from), this.tr.mapping.map(c.to));
    });
  });
  const movedBlocks = [];
  ...
  nodes.forEach(({
    ...
    this.tr.insertText(utils_createIndent(block.depth + depthDiff + 1), lastPos + 1, lastPos + block.depth + 1);
...
;
/* harmony default export */ var block_move = (move);
// CONCATENATED MODULE: ./src/actions/functions/block/pos.js
function pos_pos(stdin, args) {
...
;
/* harmony default export */ var block_pos = (pos_pos);
// CONCATENATED MODULE: ./src/actions/functions/block/remove.js
...
;
/* harmony default export */ var block_remove = (remove);
// CONCATENATED MODULE: ./src/actions/functions/block/show.js
...
/* harmony default export */ var block_show = (show);
// CONCATENATED MODULE: ./src/actions/functions/block/sort.js
  ...
  stdin.forEach(b => {
    ...
    block.children.forEach(c => {
      ...
      recurseTree(c, subc => {
        ...
        this.tr.delete(this.tr.mapping.map(subc.from), this.tr.mapping.map(subc.to));
        nodes.push({
          node,
          block: subc,
          from: c.from
    ...
    if (cursorBlock && cursorDest !== null) {
      this.tr.setSelection(prosemirror_state_dist["TextSelection"].create(this.tr.doc, cursorDest + offset));
    }
  });
  return stdin;
}
...
;
/* harmony default export */ var block_sort = (sort);
// CONCATENATED MODULE: ./src/actions/functions/block/toggle.js
...
;
/* harmony default export */ var block_toggle = (toggle);
// CONCATENATED MODULE: ./src/actions/functions/block/unindent.js



function unindent_unindent(stdin, args) {
  if (!ensureSelectorResult(stdin)) {
...
;
/* harmony default export */ var block_unindent = (unindent_unindent);
// CONCATENATED MODULE: ./src/actions/functions/date/now.js
function now(stdin, args) {
  return Date.now() / 1000 | 0;
}

/* harmony default export */ var date_now = (now);
// CONCATENATED MODULE: ./src/actions/functions/format/background.js
...
;
/* harmony default export */ var format_background = (background);
// CONCATENATED MODULE: ./src/actions/functions/format/bold.js
...
;
/* harmony default export */ var format_bold = (bold);
// CONCATENATED MODULE: ./src/actions/functions/format/clearformat.js
...
;
/* harmony default export */ var format_clearformat = (clearformat);
// CONCATENATED MODULE: ./src/actions/functions/format/color.js


function color_color(stdin, args) {
  if (!ensureSelectorResult(stdin)) {
...
;
/* harmony default export */ var format_color = (color_color);
// CONCATENATED MODULE: ./src/actions/functions/format/italic.js
...
;
/* harmony default export */ var format_italic = (italic);
// CONCATENATED MODULE: ./src/actions/functions/format/strikethrough.js
...
;
/* harmony default export */ var format_strikethrough = (strikethrough);
// CONCATENATED MODULE: ./src/actions/functions/format/underline.js
...
;
/* harmony default export */ var format_underline = (underline);
// CONCATENATED MODULE: ./src/actions/functions/misc/error.js
function error(stdin, args) {
  return this.docStruct.lastError ? this.docStruct.lastError.message : '';
}

;
/* harmony default export */ var misc_error = (error);
// CONCATENATED MODULE: ./src/actions/functions/misc/scroll.js



function scroll_scroll(stdin, args) {
  if (!ensureSelectorResult(stdin)) {
...
;
/* harmony default export */ var misc_scroll = (scroll_scroll);
// CONCATENATED MODULE: ./src/actions/functions/number/avg.js
...
;
/* harmony default export */ var number_avg = (avg);
// CONCATENATED MODULE: ./src/actions/functions/number/count.js
...
;
/* harmony default export */ var number_count = (count);
// CONCATENATED MODULE: ./src/actions/functions/number/dec.js


function dec(stdin, args) {
  if (!ensureSelectorResult(stdin)) {
    throw new InputError('dec');
  }

  if (!args.length) {
    throw new ArgumentError('dec', 'argument must have a selector');
  }

  if (args[0].type !== 'selector') {
    throw new ArgumentError('dec', 'argument must be a selector');
  }
...
;
/* harmony default export */ var number_dec = (dec);
// CONCATENATED MODULE: ./src/actions/functions/number/dollar.js
...
;
/* harmony default export */ var number_dollar = (dollar);
// CONCATENATED MODULE: ./src/lexer/ExprTokenStream.js



const is_digit = c => "0123456789".indexOf(c) !== -1;

class ExprTokenStream_ExprTokenStream extends lexer_BaseTokenStream {
  constructor(input) {
    super(input);
  }
...
/* harmony default export */ var lexer_ExprTokenStream = (ExprTokenStream_ExprTokenStream);
// CONCATENATED MODULE: ./src/actions/expr.js
...
class ExprASTStream {
  ...
  readOperator(token) {
    while (this.operatorStack.length && (expr_top(this.operatorStack).type === 'fn' || precedence(expr_top(this.operatorStack).value) >= precedence(token.value)) && expr_top(this.operatorStack).value !== '(') {
  ...
  readRightParen() {
    while (this.operatorStack.length && expr_top(this.operatorStack).value !== '(') {
      this.outputStack.push(this.operatorStack.pop());
    }

    if (this.operatorStack.length) {
      if (expr_top(this.operatorStack).value === '(') {
  ...
  parseToken(token, i) {
    ...
    if (token.type === 'paren' && token.value === '(') {
      ...
      if (!prevToken || prevToken.type !== 'number' && prevToken.type !== 'var' && prevToken.value !== ')') {
        this.operatorStack.push({
          type: 'fn',
          value: 'unary' + token.value
        });
        this.outputStack.push({
          type: 'stop'
        });
      ...
      if (expr_top(this.operatorStack).type === 'operator') {
        this.outputStack.push(this.operatorStack.pop());
      }
    }
  }
  ...
  parse() {
    ...
    while (this.operatorStack.length) {
      if (expr_top(this.operatorStack).type === 'paren') {
...
const parseExpr = src => {
  const istream = new lexer_InputStream(src);
  const tstream = new lexer_ExprTokenStream(istream);
    ...
    for (let i = 0; i < this.ast.length; ++i) {
      ...
      if (token.type === 'operator' || token.type === 'fn') {
        ...
        if (token.type === 'fn') {
          ...
          while (valueStack.length && expr_top(valueStack).type !== 'stop') {
            args.unshift(valueStack.pop().valueNum);
          }

          if (valueStack.length && expr_top(valueStack).type === 'stop') {
            valueStack.pop();
          }
...
// CONCATENATED MODULE: ./src/actions/functions/number/expr.js
...
;
/* harmony default export */ var number_expr = (expr_expr);
// CONCATENATED MODULE: ./src/actions/functions/number/inc.js
...
;
/* harmony default export */ var number_inc = (inc);
// CONCATENATED MODULE: ./src/actions/functions/number/max.js
...
;
/* harmony default export */ var number_max = (max);
// CONCATENATED MODULE: ./src/actions/functions/number/min.js
...
;
/* harmony default export */ var number_min = (min);
// CONCATENATED MODULE: ./src/actions/functions/number/pct.js
...
;
/* harmony default export */ var number_pct = (pct);
// CONCATENATED MODULE: ./src/actions/functions/number/fixed.js


function fixed_fixed(stdin, args) {
  if (!ensureAnyNumber(stdin)) {
...
;
/* harmony default export */ var number_fixed = (fixed_fixed);
// CONCATENATED MODULE: ./src/actions/functions/number/setval.js
...
function setval(stdin, args) {
  ...
  const target = args[1] && args[1].type === 'nested' ? this.executeNewContext(args[1].value, selectors) : [this.docStruct.find(this.blockFrom)];
...
;
/* harmony default export */ var number_setval = (setval);
// CONCATENATED MODULE: ./src/actions/functions/number/sum.js
...
;
/* harmony default export */ var number_sum = (sum);
// CONCATENATED MODULE: ./src/actions/functions/number/val.js
...
;
/* harmony default export */ var number_val = (val);
// CONCATENATED MODULE: ./src/actions/functions/string/compact.js
...
;
/* harmony default export */ var string_compact = (compact);
// CONCATENATED MODULE: ./src/actions/functions/string/join.js
...
;
/* harmony default export */ var string_join = (join);
// CONCATENATED MODULE: ./src/actions/functions/string/text.js


function text_text(stdin, args) {
  if (!ensureSelectorResult(stdin)) {
...
;
/* harmony default export */ var string_text = (text_text);
// CONCATENATED MODULE: ./src/actions/functions/string/trim.js
...
;
/* harmony default export */ var string_trim = (trim);
// CONCATENATED MODULE: ./src/actions/functions/tag/addtag.js
...
function addtag(stdin, args) {
  ...
  stdin.forEach(b => {
    ...
    this.tr.insertText((charBefore === ' ' ? '' : ' ') + tag, this.tr.mapping.map(b.to - tailLen - 1));
  });
  return stdin.map(b => b.applyMapping(this.tr.mapping));
}

;
/* harmony default export */ var tag_addtag = (addtag);
// CONCATENATED MODULE: ./src/actions/functions/tag/removetag.js
...
;
/* harmony default export */ var tag_removetag = (removetag);
// CONCATENATED MODULE: ./src/actions/functions/tag/toggletag.js
...
;
/* harmony default export */ var tag_toggletag = (toggletag);
// CONCATENATED MODULE: ./src/actions/functions/all.js
...
const allFunctions = {
  after: block_after,
  before: block_before,
  duplicate: block_duplicate,
  flatten: block_flatten,
  hide: block_hide,
  indent: block_indent,
  move: block_move,
  pos: block_pos,
  ...
  sort: block_sort,
  toggle: block_toggle,
  unindent: block_unindent,
  now: date_now,
  background: format_background,
  bold: format_bold,
  clearformat: format_clearformat,
  color: format_color,
  ...
  slice: selector_slice,
  'this': selector_this,
  compact: string_compact,
  join: string_join,
  text: string_text,
  trim: string_trim,
  addtag: tag_addtag,
  removetag: tag_removetag,
  toggletag: tag_toggletag,
  '>': selector_children,
  '*': selector_descendants
};
/* harmony default export */ var functions_all = (allFunctions);
// CONCATENATED MODULE: ./src/plugins/decorations.js
...
const generateDecorations = (docStruct, tr, set) => {
  set = prosemirror_view_dist["DecorationSet"].empty;
  docStruct.features.forEach(f => {
    if (f.type === 'button') {
      set = set.add(tr.doc, [prosemirror_view_dist["Decoration"].inline(f.from, f.to, {
        'class': 'code button'
      }), prosemirror_view_dist["Decoration"].widget(f.from, buttonFn(f.label, f.code, f.blockFrom, docStruct), {
      ...
      set = set.add(tr.doc, [prosemirror_view_dist["Decoration"].inline(leftTextFrom, leftTextTo, {
        'class': 'code text-wrap'
      }), prosemirror_view_dist["Decoration"].inline(rightTextFrom, rightTextTo, {
        'class': 'code text-wrap'
      }), prosemirror_view_dist["Decoration"].inline(codeFrom, f.to, {
        'class': 'code text'
      })]);
    }
  });
...
const decorationPlugin = new prosemirror_state_dist["Plugin"]({
  state: {
    init(_, state) {
    ...
    handleDOMEvents: {
      click(view, event) {
        if (event.target.tagName == "BUTTON") {
          ...
          const exec = new execute(node.code, node.blockFrom, view.state, {}, node.docStruct, functions_all);
...
/* harmony default export */ var decorations = (decorationPlugin);
// CONCATENATED MODULE: ./src/plugins/nodeview.js
...
const nodeviewPlugin = new prosemirror_state_dist["Plugin"]({
  // state: {
  // 	init (_, {doc}) {
  ...
  props: {
    nodeViews: {
      block(node) {
        return new nodeview_BlockView(node);
      }

    }
  }
});
/* harmony default export */ var nodeview = (nodeviewPlugin);
// CONCATENATED MODULE: ./src/plugins/extract.js
...
class extract_TokenStream extends lexer_BaseTokenStream {
  constructor(input) {
    super(input);
  }
...
const extract = input => {
  const istream = new lexer_InputStream(input);
  const tstream = new extract_TokenStream(istream);
  const blocks = [];
...
// CONCATENATED MODULE: ./src/tree/document.js
...
class document_DocumentStructure {
  constructor() {
    this.reset();
    this.lastError = null;
  }
  ...
  build(state) {
    ...
    state.doc.descendants((node, pos) => {
      ...
      features.forEach(f => {
        if (f.type === 'tag') {
          if (!this.index[f.label]) this.index[f.label] = []; // only add block once

          if (this.index[f.label].indexOf(block) === -1) this.index[f.label].push(block);
...
/* harmony default export */ var tree_document = (document_DocumentStructure);
// CONCATENATED MODULE: ./src/plugins/docStruct.js



const docStructPlugin = docStructKey => new prosemirror_state_dist["Plugin"]({
  key: docStructKey,
  state: {
    init() {
...
/* harmony default export */ var plugins_docStruct = (docStructPlugin);
// CONCATENATED MODULE: ./src/collab/constants.js
...
// CONCATENATED MODULE: ./src/collab/orchestrator.js




class orchestrator_CollabOrchestrator {
  ...
  onMessage(msg) {
    if (msg.type === 'online') {
      ...
      window.dispatchEvent(new CustomEvent("collabError", {
        detail: msg
      }));
    } else {
  ...
  applyChanges({
    ...
    const schemaSteps = steps.map(s => prosemirror_transform_dist["Step"].fromJSON(this.schema, s));
    this.document.dispatch(Object(dist_collab["receiveTransaction"])(this.document.state, schemaSteps, clientIDs));
    this.collabState.setLocalVersion(Object(dist_collab["getVersion"])(this.document.state));
  }

  localSyncRequest() {
    const type = M_SENDABLE;
    const payload = Object(dist_collab["sendableSteps"])(this.document.state);
    const msg = {
      type,
      payload
    };
...
/* harmony default export */ var orchestrator = (orchestrator_CollabOrchestrator);
// CONCATENATED MODULE: ./src/collab/event.js
class EventEmitter {
  constructor() {
    this._handlers = {};
  }
...
/* harmony default export */ var collab_event = (EventEmitter);
// CONCATENATED MODULE: ./src/collab/state.js
...
class state_LocalSync extends State {
  constructor(changes) {
    super();
...
class state_RemoteSync extends State {
  enter(collab) {
...
class state_Idle extends State {
  ...
  handle(collab, type, msg) {
    if (collab.needsRemoteSync()) {
      ...
      return new state_LocalSync(msg.payload);
    }
  }

}

class state_CollabState extends collab_event {
  constructor(localVersion, serverVersion) {
    super();
    this.localVersion = localVersion;
    this.serverVersion = serverVersion;
    this.state = new state_Idle();
  }
...
/* harmony default export */ var collab_state = (state_CollabState);
// CONCATENATED MODULE: ./src/collab/connection.js

const TIMEOUT_MS = 30000;

class connection_Connection extends collab_event {
  constructor(url) {
    super();
    this.ws = null;
    this.url = url;
...
const editor_execute = (originalDoc, state, meta, docStruct) => {
  meta.addToHistory = false;
  let docChanged = false;
  let currentState = state;
  let mapping = new prosemirror_transform_dist["Mapping"]();
  docStruct.features.filter(f => (f.type === 'imm' || f.type === 'text') && f.ast).forEach(f => {
    const exec = new execute(f.ast, mapping.map(f.blockFrom), currentState, meta, docStruct, functions_all);
    let out = exec.execute();
    currentState = exec.currentState;
    mapping.appendMapping(exec.mapping); // executor reports whether it should update
...
const MAX_TICK = 100;
const editor_docStructKey = new prosemirror_state_dist["PluginKey"]('docStructKey');
const domParser = dist["DOMParser"].fromSchema(src_schema);
const clipboardParser = {
  parseSlice(dom, opts) {
    ...
    const nodes = [];
    blocks.forEach(b => {
      nodes.push(dist["Node"].fromJSON(src_schema, {
        type: 'block',
        content: b ? [{
          type: 'text',
          text: b
    ...
    const fragment = dist["Fragment"].fromArray(nodes);
    const slice = dist["Slice"].maxOpen(fragment);
    return slice;
  }
...
const init = (editor, version, doc, websocketUrl) => {
  const state = prosemirror_state_dist["EditorState"].create({
    doc: src_schema.nodeFromJSON(doc),
    schema: src_schema,
    plugins: [plugins_docStruct(editor_docStructKey), Object(dist_history["history"])(), indentKeymap(), Object(keymap["keymap"])({
      "Mod-z": dist_history["undo"],
      "Mod-y": dist_history["redo"]
    }), Object(keymap["keymap"])(commands["baseKeymap"]), decorations, nodeview, Object(dist_collab["collab"])({
      version: version
    })]
  });
  const view = new prosemirror_view_dist["EditorView"](editor, {
    state,
  ...
  editor_docStructKey.getState(view.state).build(view.state);
  const execResponse = editor_execute(view.state.doc, view.state, {}, editor_docStructKey.getState(view.state));
  ...
  const loop = () => {
    ...
    if (view.shouldUpdate && now - lastUpdated > MAX_TICK) {
      const execResponse = editor_execute(view.state.doc, view.state, {
        addToHistory: false
      }, editor_docStructKey.getState(view.state));
      view.shouldUpdate = execResponse.docChanged;
      view.updateState(execResponse.currentState);
      console.log('tick');
      lastUpdated = now;
  ...
  const collabState = new collab_state(version, version);
  const collabOrchestrator = new orchestrator(collabState, conn, view, src_schema);
...
/* harmony default export */ var src_editor = (init);
// CONCATENATED MODULE: ./src/actions/functions/readonly.js
...
/* harmony default export */ var readonly = (readonlyFunctions);
// CONCATENATED MODULE: ./src/index.js
/* concated harmony reexport schema */__webpack_require__.d(__webpack_exports__, "schema", function() { return src_schema; });
/* concated harmony reexport editor */__webpack_require__.d(__webpack_exports__, "editor", function() { return src_editor; });
/* concated harmony reexport Executor */__webpack_require__.d(__webpack_exports__, "Executor", function() { return execute; });
/* concated harmony reexport DocumentStructure */__webpack_require__.d(__webpack_exports__, "DocumentStructure", function() { return tree_document; });
/* concated harmony reexport parse */__webpack_require__.d(__webpack_exports__, "parse", function() { return parse; });
/* concated harmony reexport readonlyFunctions */__webpack_require__.d(__webpack_exports__, "readonlyFunctions", function() { return readonly; });
/* concated harmony reexport ensureSelectorResult */__webpack_require__.d(__webpack_exports__, "ensureSelectorResult", function() { return ensureSelectorResult; });
